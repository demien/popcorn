...
from popcorn.tests.mock_tool import App, Pool
...
class TestIntegration(unittest.TestCase):
    ...
    def test_worker_pool_grow(self):
        ...
        planner.strategy.apply = MagicMock(return_value=self.worker_cnt)
        ...
        self.guard.pool.get_or_create_pool_name = MagicMock(return_value=self.queue)
        time.sleep(1)
